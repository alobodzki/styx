...
public @interface StyxProperty
{
     ...
     * its effects may be further overridden by {@link StyxIgnore} property:
     * if both annotations are present on an accessors, {@link StyxIgnore}
